...
public class SyncMessageCreatorTest {
	...
	public void createMessage_shouldCreateJmsMessage() throws Exception {
		...
		final String siteId = "test-site-id";
		SyncMessageCreator creator = new SyncMessageCreator(body, msgUuid, siteId);
		...
		Mockito.verify(msg).setStringProperty(eq(SyncConstants.JMS_HEADER_MSG_ID), eq(msgUuid));
